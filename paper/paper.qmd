...
While not as influential as the argument from inductive risk [@DouglasInductiveRiskValues2000; @HavstadSensationalScienceArchaic2021], the aims approach to values in science provides a distinct challenge to the value-free ideal. Proponents of the approach argue that science typically has not only epistemic aims but also practical or pragmatic ones, and that at any stage of inquiry decisions should be made so as to promote those aims. So, specifically, in the "core" of inquiry decisions should be made so as to promote pragmatic aims, and in this way non-epistemic values can play a legitimate role in the "core" of inquiry. *[cites]*  For example, @ElliottNonepistemicValuesMultiple2014 argue that the pragmatic aim of quick and protective regulatory review in chemical safety testing supports using rapid screening techniques, which are much faster than other methods but will likely have a higher false positive rate. 

Note that this argument does not necessarily deny that science has epistemic aims, as may be done by approaches inspired by John Dewey [@AndersonUsesValueJudgments2004; @BrownScienceMoralImagination2020] or Donald Davidson [@CloughRacistValueJudgments2008; @CloughUsingValuesEvidence2020]. This argument is also independent of questions about the definition of epistemic values or a sharp demarcation of values into "epistemic" vs. "social" [@McMullinValuesScience1982; @RooneyValuesScienceEpistemic1992; @LonginoGenderPoliticsTheoretical1995; @SteelEpistemicValuesArgument2010]. Instead, the key assumption of this argument is that science does not have *only* epistemic aims. 

Proponents of the aims approach often argue for pluralism about aims of science [@ElliottNonepistemicValuesMultiple2014; @PotochnikDiverseAimsScience2015; @PotochnikIdealizationAimsScience2017], with @LuskGlobalAimsScience2024 explicitly rejecting "the view that science has global aims that constrain the influence of local aims on scientific practice" (1). Both epistemic and pragmatic aims are often presented as specific to a discipline, field, or research program *[@ElliottTapestryValuesIntroduction2017 ch. 4; examples]*. @IntemannDistinguishingLegitimateIllegitimate2015 coined the term "aims approach," and argued for "democratically endorsed epistemological and social aims of research" (2), which will be pluralistic insofar as different polities democratically endorse different aims. *[more?]*

A distinctive aspect of @HicksWhenVirtuesAre2022 version of the aims approach is an analysis of two general "views" of the aims of science, and a claim that an unrecognized disagreement between the two views is a recurrent feature of debates, not only among scientists and the public but also among philosophers.  For Hicks, the "broad view" corresponds to the aims approach argument sketched above — science has both epistemic and pragmatic aims — while the "narrow view" denies the "key assumption" of that argument, taking science to have only epistemic aims *[cites]*. On the narrow view, applications of scientific research are seen as happy accidents but not the primary function or purpose of research. Allowing pragmatic considerations (read: non-epistemic values) to influence inquiry is a corrupting influence and a form of research misconduct, *morally* on a par with the epistemic distortions introduced by industrial funding [@HolmanExperimentationIndustrialSelection2017; @FernandezPintoEpistemicDiversityIndustrial2023] or fraud [@BrightWhyScientistsLie2021]. 

Something like Hicks' two views of the aims of science appears in philosophical debates over the argument from inductive risk. First, the argument itself treats the non-epistemic consequences of research as on a par with the epistemic consequences, similarly to the way the broad view does not prioritize epistemic aims over pragmatic ones. Next, in his objection to Rudner's original formulation of the argument, @LeviMustScientistMake1960 claimed that Rudner (and other proponents of the argument) relied on an assumption that "To choose to accept a hypothesis as true (or to believe that H is true) is equivalent to choosing to act on the basis of H relative to some specific objective P" (348), which he associated with decision theory and, later, behaviorism [@LeviSeriousnessMistakes1962]. Denying this assumption, @LeviMustScientistMake1960 distinguished the "theoretical" or epistemic objective of "accepting true answers to questions as true" from "practical" objectives (350). Similarly, @LeviSeriousnessMistakes1962 defends the view that the aim of scientific inquiry is to "replace doubt by true belief" (48).  This aim might include either "seek[ing] the truth and nothing but the truth" or, more broadly, "certain desirable properties in addition to truth" such as "simplicity, explanatory power," and presumably other epistemic virtues (48).  But, on either construal, "replac[ing] doubt by true belief" is "theoretical" or epistemic and "non-behavioral" (48). In other words, Levi objected to the argument from inductive risk by articulating the narrow view. *[Franco cites]*. Finally, in response to similar critiques of *[Douglas']* version of the argument *[eg, Lacey; Mayo?]*, critics of the value-free ideal adopted *[Cohen's?]* distinction between belief (in a claim as true) and acceptance (for practical purposes), explicitly scoping their arguments to acceptance *[cites]*. This move in the debate concedes Levi's rejection of the "behaviorist" identification of belief and acceptance — but also rejects the narrow view's purely epistemic aims for inquiry, placing defenders and critics of VFI on opposite sides of the two views of the aims of science. 
...
We argue that the results above can be fruitfully understood in terms of Hicks' -@HicksWhenVirtuesAre2022 account of two views of the aims of science.  Specifically, we claim that supporters deployed the narrow view, while opponents deployed the broad view.  
...
As an alternative to the aims approach, our findings might be interpreted in terms of inductive risk, and specifically differences between supporters and opponents in the relative importance of over- vs. under-regulation [compare @HicksScientificControversiesProxy2017 on climate change].  That is, supporters of ST might put more weight on over-regulation and preventable economic harms; while opponents of ST might put more weight on under-regulation and preventable disease and loss of life due to pollution.  
...
Yet another alternative account of this controversy would be in terms of the value-free ideal, understood as the view that non-epistemic values must not influence the "internal" or "core" stages of scientific inquiry — analyzing evidence, evaluating hypotheses — but may permissibly influence "earlier" and "later" stages of inquiry — such as posing research questions and utilizing research findings in policymaking. On this reading, supporters of ST perceive EPA/regulatory science as frequently violating the value-free ideal — perhaps environmentalist or "leftist" values are influencing the evaluation of hypotheses — while opponents do not.^[Thanks to [redacted]<!-- Soazig Le Bihan --> for suggesting a version of this objection. [Their] version did not tie the internal/external influence distinction to the value-free ideal.] 

This account is not as much of an alternative to our aims-based account as it might seem. @HicksWhenVirtuesAre2022 argues that the narrow view is often assumed by defenders of the value-free ideal (VFI), and so for supporters of ST there's not much difference between "failing to achieve narrowly epistemic aims" and "violating VFI." However, for opponents of ST, this alternative account would require parsing their comments on ST into VFI's three-stage model of inquiry, and showing that they view non-epistemic values as influencing only the "external" stages (research questions and downstream applications). Concerns that ST would enable "political interference" — presidential appointees influencing the evaluation of hypotheses and conclusions reached by scientific reports — can be read as concerns about VFI violations. But other concerns would be much more difficult to parse in terms of the three-stage model assumed by VFI. 

The VFI-based account of the ST controversy also does not fit well with empirical research on the relationship among VFI, cynicism about science, and trust in science among members of the general public in the US. @HicksDevelopingMeasuresPublic2024 find that members of the public generally agree with VFI, and the average score along a composite measure of "objectivity" is relatively high. But they also find that this measure does not predict trust in science. Instead a different composite measure, "cynicism," predicts trust in science,^[Specifically, a high score on the cynicism scale is a good predictor of *lower* trust in science.] and cynicism and objectivity are not correlated with each other. @HicksDevelopingMeasuresPublic2024 also connect the cynicism measure to the failure of science to achieve its aims. Below we discuss how supporters of ST often express significant cynicism towards EPA/regulatory science. 
