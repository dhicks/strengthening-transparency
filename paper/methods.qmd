...
After scraping, our corpus included the text of 22,390 comments and attachments for 20,787 distinct comments.  *[try reruning scraper sometime]*  We refer to this collection of comments and attachments as the *ST corpus*.  By number of attachments, the median document had no attachments and the maximum number of attachments was 17.  
...
## Keyword synonyms and exclusions
